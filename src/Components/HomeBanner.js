        ...
        <div className="services-area lg:py-[100px] py-[50px] font-roboto">
          <Container>
            <div className="section-title">
              ...
              <h2>
                Comprehensive <b>Specialty-Specific EMR</b> Solutions
              </h2>
            </div>
            ...
            <Row className="justify-content-center">
              ...
              <Col lg={4} sm={6}>
                <div className="why-choose-us-card">
                  ...
                  <h3>Ease of use</h3>
                  <p>
                    Very easy and accurate documentation, easy implementation of
                    EMR
                  </p>
                </div>
              </Col>
              <Col lg={4} sm={6}>
                <div className="why-choose-us-card">
                  ...
                  <h3>Tailor made</h3>
                  <p>
                    Customized to fit the specific requirements of each
                    practice.
                  </p>
                </div>
              </Col>
            ...
            <Row className="mt-5 justify-content-center">
              <Col lg={4} sm={6}>
                <div className="why-choose-us-card">
                  ...
                  <h3>Customizable</h3>
                  <p>
                    Can be customized by the user anytime in the future, to suit
                    the changing scenarios and trends.
                  </p>
                </div>
              </Col>
              <Col lg={4} sm={6}>
                <div className="why-choose-us-card">
                  ...
                  <p>scribble or type. DICOM, HL7, Lab and Fax interfacing</p>
                </div>
              </Col>
              <Col lg={4} sm={6}>
                <div className="why-choose-us-card">
                  ...
                  <p>
                    Prescription (eRx), Integrated Billing, and AR Modules for
                    Seamless Operations.
                  </p>
                </div>
              </Col>
