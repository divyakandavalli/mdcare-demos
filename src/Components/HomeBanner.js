    ...
    <>
      <section className='banner-backgeound'>
        <section className='medical-center-banner-area'>
          <Row>
            <Col lg={6}>
              <div className='medical-center-banner-content w-[650px]'>
                <h1 className='title text-4xl lg:text-[60px] mb-4 leading-normal text-[#020D2B] font-[500]'>
                  <b className='font-[800]'>Transforming Lives,</b> Restoring
                  Your Health
                </h1>
                <p className='w-[595px]'>
                  With the ongoing trends in Information Technology, where
                  change is an obsession, time a limited commodity, and quality
                  the hallmark of every business, Vision Infonet Inc has created
                  its niche in the industry by providing healthcare providers
                  the best.
                </p>
